package com.example.chikara.gover_down;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    double  lon;
    long logseconds;
    double box[] = {32.87544,32.890890,130.746771,130.750775        //kousenn
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(provider!=null) {
            ...
            TextView ntext = (TextView)findViewById(R.id.nons);
            ntext.setText("現在地の取得中です");
        }
...

        {
            ...
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("http://edu3.te.kumamoto-nct.ac.jp:8088/~te14morita/pbl/pbl.html");
